...
#define CE_L GPIO_ResetBits(GPIOA,GPIO_Pin_11)//拉低使能位
#define CE_H GPIO_SetBits(GPIOA,GPIO_Pin_11)//拉高使能位
#define SCLK_L GPIO_ResetBits(GPIOA,GPIO_Pin_12)//拉低时钟线
#define SCLK_H  GPIO_SetBits(GPIOA,GPIO_Pin_12)//拉高时钟线
#define DATA_L  GPIO_ResetBits(GPIOA,GPIO_Pin_8)//拉低数据线
#define DATA_H  GPIO_SetBits(GPIOA,GPIO_Pin_8)//拉高数据线
